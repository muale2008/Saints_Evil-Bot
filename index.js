...
let phoneNumber = global.PAIRING_NUMBER || process.env.PAIRING_NUMBER || "233206777968";
let owner = JSON.parse(fs.readFileSync('./data/owner.json'));

global.botname = process.env.BOT_NAME || "Saints_Evil-Bot";
global.themeemoji = "•";
        ...
        QasimDev.ev.on('connection.update', async (s) => {
            ...
            if (connection == "open") {
                ...
                try {
                 ...
                 await delay(1999);
                console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'Saints_Evil-Bot'} ]`)}\n\n`));
