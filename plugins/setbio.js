...
async function fetchQuotes() {
  try {
    ...
    if (allQuotes.length === 0) {
      ...
      return [
        '💎 By Saints_Evil-Bot - Your WhatsApp Bot',
    ...
    return cachedQuotes.length > 0 ? cachedQuotes : ['💎 By Saints_Evil-Bot - Your WhatsApp Bot'];
  }
}

function getRandomQuote(quotes) {
  if (!quotes || quotes.length === 0) return '💎 By Saints_Evil-Bot';
