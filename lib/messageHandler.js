...
async function handleMessages(sock, messageUpdate) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '*Join our Channel:*\n[https://whatsapp.com/channel/0029VbCMnRAEgGfGnpp5H41y](https://whatsapp.com/channel/0029VbCMnRAEgGfGnpp5H41y)' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `*Support*\n\nhttps://whatsapp.com/channel/0029VbCMnRAEgGfGnpp5H41y` 
                }, { quoted: message });
                return;
            }
        }
